      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl sm:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in delay-500">
            Welcome to my world of artistic expression. I'm here to help you
            discover your inner performer through
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive training programs designed to nurture your artistic
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="group relative overflow-hidden rounded-2xl p-8 bg-white border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2"
              >
                <div
                ...
                <div
                  className={`mt-6 w-12 h-1 bg-gradient-to-r ${service.color} rounded-full group-hover:w-20 transition-all duration-300`}
                ></div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-coral-50 to-purple-50">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            ...
            I'm here to guide you every step of the way. Let's unlock your
            potential together.
          </p>
          <Link
            to="/contact"
