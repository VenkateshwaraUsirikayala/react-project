            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        ...
                        { url: "https://cdn.bhavanjali.art/Supriya-Video-Review.mp4",thumbnail: 'https://cdn.bhavanjali.art/thumbnails/Supriya-thumbnail.png', title: "Supriya’s Learning Experience in Bharatanatyam", description: "Adult learner shares how the art of Adavus is mastered one at a time, with care and dedication." },
                        { url: "https://cdn.bhavanjali.art/Snehal-Patil-Video-Review.mp4",thumbnail: 'https://cdn.bhavanjali.art/thumbnails/Snehal-Patil-thumbnail.png', title: "Snehal Patil : From Learner to Performer", description: "Young Enthusiast’s Journey from Learning to Stage Performances" }
                    ].map((video, index) => (
                        <div
                            key={index}
